...
![Registration Screen](task5_readme/register_Screen_run.png)

**Step 2:** Log in with the newly created account.  
![Login Screen](task5_readme/login_run.png)

**Step 3:** Arrive at the Home page.  
![Home Page](task5_readme/homeafterlogin_run.png)

**Step 4:** Open the side menu and create a new folder named **"new folder"**.  
![Side Menu](task5_readme/newfolder_run.png)
