...
![Registration Screen](images/task5_readme/register_Screen_run.png)  
**Step 1:** Register a new user.

![Login Screen](images/task5_readme/login_run.png)  
**Step 2:** Log in with the newly created account.

![Home Page](images/task5_readme/homeafterlogin_run.png)  
**Step 3:** Arrive at the Home page.

![Side Menu](images/task5_readme/newfolder_run.png)  
**Step 4:** Open the side menu and create a new folder named **"new folder"**.

![My Drive Page](images/task5_readme/newfile_run.png)  
**Step 5:** Enter **"new folder"** and create a new file named **"New file"**.

![Edit File Form](images/task5_readme/fileafteredit.png)  
**Step 6:** Edit the content of **"New file"** and save the changes.

![Picture Form](images/task5_readme/imageupload.png)  
**Step 7:** Create a new image file inside **"new folder"**.

![Edit Picture Form](images/task5_readme/imageafteredit.png)  
**Step 8:** Edit the image by replacing or updating the picture.

![Item Options Menu](images/task5_readme/sharedfile.png)  
...
![Starred Page](images/task5_readme/starredfile.png)  
**Step 11:** Open the **Starred** page to verify the file appears as starred.

![My Drive Page](images/task5_readme/fileintrash.png)  
...
![My Drive Page](images/task5_readme/filedeleted.png)  
**Step 14:** Delete **"new name file"** permanently.

![Recent Page](images/task5_readme/recentpage.png)  
